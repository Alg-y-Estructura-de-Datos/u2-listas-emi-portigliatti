...
void agregarEstudiantes(ListaDoble<Estudiante>& lista) {
    lista.insertarUltimo(Estudiante("Kevin", 20));
    lista.insertarUltimo(Estudiante("Luisa", 22));
    lista.insertarUltimo(Estudiante("Martina", 19));
    lista.insertarUltimo(Estudiante("Lucas", 21));
    lista.insertarUltimo(Estudiante("Gabriel", 23));
}
